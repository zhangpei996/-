    ...
    /*            alert('登录成功');*/
        ...
        function register(){
            ...
            if(flag){
                ...
                spop({
                    template: '<h4 class="spop-title">注册成功</h4>即将于3秒后跳转网站首页',
                    position: 'top-center',
                    style: 'success',
                    autoclose: 3000,
                    onOpen : function(){
                        ...
                        var showPop = setInterval(function(){
                            ...
                            $('.spop-body').html('<h4 class="spop-title">注册成功</h4>即将于'+second+'秒后跳转');
                            second--;
                        },1000);
                    },
/*                    onClose : function(){
...
<div id="login">
    ...
    <div class="wrapper">
            ...
            <form class="container offset1 loginform" action="login" method="post">
                ...
                <div class="pad input-container">
                    <section class="content">
                        ...
                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" id="login-password" name="pwd" placeholder="请输入密码" tabindex="2" maxlength="15"/>
                        ...
                        <span class="input">
								<input class="input__field " type="button" value="点击验证" tabindex="1" maxlength="15"
                                       id="TencentCaptcha"
                                       data-appid="2052527248"
                                       data-cbfn="callback"
                                       type="button"/>
                            <!--<label class="input__label input__label--hideo" for="login-password">
                                <i class="fa fa-fw fa-lock icon icon--hideo"></i>
                ...
                <div class="form-actions">
                    <a tabindex="4" class="btn pull-left btn-link text-muted" onClick="goto_register()">注册</a>
                    <a tabindex="5" class="btn btn-link text-muted" onClick="goto_register()"></a>
                    <input class="btn btn-primary" disabled="disabled" type="submit" tabindex="3"  onClick="return login()" value="登录"
                     id = "login01"  style="color:white;"/>
                </div>
            </form>
        ...
        <div class="login sign-up-htm">
            ...
            <form action="saveuser" method="get" class="container offset1 loginform">
                <!-- 猫头鹰控件 -->
                    ...
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-username"
                                    name="userName"  autocomplete="off" placeholder="请输入用户名" maxlength="15" onblur="judgeName()"/>
                        ...
                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" name="pwd" type="password" id="register-password" placeholder="请输入密码" maxlength="15"/>
                ...
                <div class="form-actions">
                    <a class="btn pull-left btn-link text-muted" onClick="goto_login()">返回登录</a>
                    <input class="btn btn-primary" type="submit" onClick="return register()" value="注册" style="color:white;"/>
                </div>
            </form>
        </div>
    </div>
...
<script>
    window.callback = function(res){
        ...
        if(res.ret === 0){
            $("#login01").attr('disabled',false);  // 票据
            $.pt({
                target: $("#TencentCaptcha"),
                position: 'r',
                align: 't',
                width: 'auto',
                height: 'auto',
